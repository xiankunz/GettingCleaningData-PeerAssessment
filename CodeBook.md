...
The result is saved as labeled_output_data.txt, a 10299x68 data frame
...
of each measurement for each activity and each subject. The result is saved as tidy_output_data.txt